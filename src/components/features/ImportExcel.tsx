...
const moduleAliases: Record<ModuleKey, string[]> = {
  ...
  deposit_accounts: ["חשבונות", "חשבונות להפקדה", "accounts", "deposit accounts"],
  ...
  mortgage_release: ["שחרור משכנתא", "mortgage"],
};
...
const fieldAliases: Record<string, string[]> = {
  ...
  category: ["קטגוריה"],
  action: ["פעולה"],
  email: ["מייל", "אימייל", "דואל", "דוא\"ל"],
  notes: ["הערות"],
  title: ["שם תבנית", "תבנית", "שם"],
  subject: ["נושא"],
  body: ["גוף התבנית", "גוף", "תוכן"],
  system: ["מערכת"],
  url: ["URL", "קישור"],
